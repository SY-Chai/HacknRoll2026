        ...
        <div className="full-screen" style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'auto' }}>
            ...
            <div style={{ padding: '12px 24px', zIndex: 10, display: 'flex', alignItems: 'center', position: 'relative' }}>
                ...
                <div style={{ flex: 1, display: 'flex', justifyContent: 'flex-end', gap: '12px', alignItems: 'center' }}>
                    ...
                    {/* Audio Controls */}
                    {isAudioProcessing ? (
                        <div className="glass-panel" style={{ padding: '12px', color: 'rgba(255,255,255,0.5)', display: 'flex', gap: '8px', alignItems: 'center' }}>
                    ...
                    >
                        <button
                            ...
                            style={{
                                ...
                                background: 'rgba(255,255,255,0.1)', border: 'none', borderRadius: '50%', padding: '12px',
