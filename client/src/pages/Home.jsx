...
export default function Home() {
    ...
    return (
        <div className="full-screen" style={{ position: 'relative', overflowY: 'auto', overflowX: 'hidden' }}>
            {/* Background 3D Scene */}
            ...
            <div className="container" style={{
                ...
                >
                    <div style={{
                        ...
                        <span style={{ fontSize: '0.85rem', color: '#eee', letterSpacing: '0.5px' }}>
                    ...
                    <h1 className="glow-text" style={{
                        ...
                        Time Capsule <span style={{ fontWeight: 700, color: '#fff' }}>SG</span>
                    </h1>
                    <p style={{
                        ...
                        Journey through the decades. Uncover the stories of the past with a single search.
                    </p>
                </motion.div>
